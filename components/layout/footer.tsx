        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-5">
              متجر فلورا — وجهتك المفضلة للإكسسوارات الأنيقة، الهدايا الفاخرة، والعطور المميزة.
            </p>

            {/* Social links */}
            <div className="flex items-center gap-3">
              <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center hover:opacity-80 transition-opacity">
              ...
              <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer"
                ...
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.72a8.16 8.16 0 004.77 1.52V6.79a4.85 4.85 0 01-1-.1z"/>
                </svg>
              </a>
              ...
              <a href={SOCIAL_LINKS.whatsapp} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-green-600 flex items-center justify-center hover:opacity-80 transition-opacity">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { href: "/offers",   label: "العروض والتخفيضات" },
          ...
          <div>
            ...
            <ul className="space-y-2 mb-6">
              {[
                ...
                { href: "/return-policy",   label: "سياسة الاسترجاع" },
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} فلورا ستور. جميع الحقوق محفوظة.
          </p>
          <div className="flex items-center gap-3">
            {["مدى", "Visa", "Mastercard", "STC Pay", "Apple Pay"].map((m) => (
              <span key={m} className="text-xs text-gray-600 bg-gray-800 px-2 py-1 rounded-md">
                {m}
              </span>
            ))}
          </div>
